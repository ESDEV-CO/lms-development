                    ...
                    <div class="footer-widget footer-about">
                        ...
                        <div class="footer-social mt-30">
                            <ul class="d-flex align-items-center">
                                ...
                                <li><a href="{{get_option('instagram_url')}}"><span class="iconify" data-icon="fa-brands:instagram-square" data-width="1em" data-height="1em"></span></a></li>
                                @endif
                                @if(get_option('tiktok_url'))
                                <li><a href="{{get_option('tiktok_url')}}"><span class="iconify" data-icon="iconoir:tiktok" data-width="1em" data-height="1em"></span></a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="footer-links d-flex">
                            <ul>
                                ...
                                <li><a href="{{  $footerLeftMenu->url }}">{{
                                        __($footerLeftMenu->name) }}</a></li>
                                @endforeach
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="footer-links d-flex">
                            <ul>
                                ...
                                <li><a href="{{  $footerRightMenu->url }}">{{
                                        __($footerRightMenu->name) }}</a></li>
                                @endforeach
                    ...
                    <div class="footer-widget footer-contact-info">
                        ...
                        <div class="footer-links d-flex">
                            <ul>
                                ...
                                <li><span class="iconify" data-icon="fluent-emoji-high-contrast:telephone-receiver"></span><a href="tel:{{ get_option('app_contact_number') }}">{{ __(get_option('app_contact_number')) }}</a></li>
                                <li><span class="iconify" data-icon="ic:round-email"></span><a href="mailto:{{ get_option('app_email') }}">{{ __(get_option('app_email')) }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
